...
export default function ProductPage() {
  ...
  const availableColors = Array.from(
    new Set(variants.filter((v) => v.color && v.stock_quantity > 0).map((v) => v.color!)),
  )
  ...
  const selectedVariant = variants.find((v) =>
    selectedColor ? v.color === selectedColor && v.size === selectedSize : !v.color && v.size === selectedSize,
  )
  ...
  const handleBuyViaWhatsAppClick = () => {
    if (availableColors.length > 0 && !selectedColor) {
      showToast("Veuillez sélectionner une couleur", "warning")
      return
    }
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "25px" }}>
              ...
              {[...Array(5)].map((_, i) => (
                <Star
                  ...
                  style={{
                    width: "20px",
                    height: "20px",
                    color: i < Math.floor(product.rating || 0) ? "#1f2937" : "#6b7280",
                    fill: i < Math.floor(product.rating || 0) ? "#1f2937" : "none",
                  }}
                />
              ))}
            </div>
                ...
                {availableColors.map((color) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      />
                      <span style={{ color: isSelected ? "#1f2937" : hasStock ? "#1f2937" : "#9ca3af" }}>{color}</span>
                      {!hasStock && <span style={{ fontSize: "10px", color: "#6b7280" }}>Rupture</span>}
                    </button>
                  )
                })}
              </div>
            ...
            <div>
              ...
              <div style={{ display: "flex", flexWrap: "wrap", gap: "10px" }}>
                {availableSizesForColor.map((variant) => (
                  <button
                    ...
                    style={{
                      padding: "12px 16px",
                      border: selectedSize === variant.size ? "2px solid #1f2937" : "2px solid #d1d5db",
                      backgroundColor: selectedSize === variant.size ? "#f0f0f0" : "white",
                      color:
              ...
              {selectedSize && selectedVariant && (
                <p style={{ fontSize: "14px", color: "#6b7280", marginTop: "10px" }}>
                  Stock disponible: {selectedVariant.stock_quantity} pièce
          ...
          <div style={{ display: "flex", gap: "15px", alignItems: "center" }}>
            <span
              style={{
                backgroundColor: isInStock ? "#1f2937" : "#6b7280",
                color: "white",
                padding: "6px 12px",
                borderRadius: "4px",
                fontSize: "14px",
